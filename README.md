...
-   Examples of resource-context permissions with Log Analytics Workspace.
-   Recommendations for RBAC based on Resource Groups & Subscriptions & working example.
-   Alert processing rules per API when multiple APIs are grouped in a single Application Insights.
